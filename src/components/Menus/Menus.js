...
class Menus extends Component {
    ...
    handleClick = async e => {
        ...
        if (!["wine", "food", "cocktails"].includes(activeMenu)) {
            return null;
        }
        ...
        return (
            <div className="Menus">
                ...
                <div className="menus_titles">
                    <h1
                        id="food"
                        className={`menus__link ${activeMenu === "food" &&
                            "menus__link--active"}`}
                    ...
                    <h1
                        id="cocktails"
                        className={`menus__link ${activeMenu === "cocktails" &&
                            "menus__link--active"}`}
                        onClick={this.handleClick}
                    >
                        Cocktails
                    ...
                    <h1
                        id="wine"
                        className={`menus__link ${activeMenu === "wine" &&
                            "menus__link--active"}`}
                        onClick={this.handleClick}
                    >
                        Wine
                ...
                <div
                    className={`menus__active ${
                        menuIsLeaving ? "menus__active-leaving" : null
                    }`}
                >
